...
public class TFileInputXMLEndJava
{
  ...
  protected final String TEXT_21 = NL + "\ttry {" + NL + "\t\tlooper_";
  protected final String TEXT_22 = ".handleTaskResponse();" + NL + "\t} catch(java.lang.Exception e) {" + NL + "\t\tif(!(e.getCause() instanceof org.talend.xml.sax.exception.EnoughDataException))" + NL + "\t";
  protected final String TEXT_23 = NL + "\t\tthrow(e);" + NL + "\t";
  protected final String TEXT_24 = NL + "\t\t";
  protected final String TEXT_25 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_26 = " - \" +  e.getMessage());" + NL + "\t\t";
  protected final String TEXT_27 = NL + "\t\tSystem.err.println(e.getMessage());\t" + NL + "\t";
