...
package local_project.t_aggr_0_1;
...
/**
 * Job: t_aggr Purpose: t_aggr<br>
 * Description: t_aggr <br>
 * 
 * @author mdsalmankhan89@gmail.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class t_aggr implements TalendJob {
	...
	private final String jobName = "t_aggr";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(t_aggr.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_t_aggr = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_t_aggr = new byte[0];
		...
		public Integer GenderWiseCount;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_t_aggr.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_t_aggr.length == 0) {
						commonByteArray_LOCAL_PROJECT_t_aggr = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_t_aggr = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_t_aggr, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_t_aggr, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_t_aggr) {
				...
				try {
					...
					this.GenderWiseCount = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.GenderWiseCount, dos);
		...
		public String toString() {
			...
			sb.append(",GenderWiseCount=" + String.valueOf(GenderWiseCount));
			sb.append("]");
...
// ------------
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					String gender;
					int count = 0;
					int GenderWiseCount_clmCount = 0;
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:a0gAIe6V385X0CBiPQ6e2BeR/JsNN9hDHoElBOW1K191");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.dob = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.dob = tmpContent_tDBInput_1;
								}
							} else {
								row1.dob = null;
							}
						...
						operation_finder_tAggregateRow_1.gender = row1.gender;
						...
						if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
							...
							operation_result_tAggregateRow_1.gender = operation_finder_tAggregateRow_1.gender;
						...
						operation_result_tAggregateRow_1.GenderWiseCount_clmCount++;
				...
				util_tLogRow_2.addRow(new String[] { "gender", "GenderWiseCount", });
...
///////////////////////    			
				...
				util_tLogRow_3.addRow(new String[] { "gender", "GenderWiseCount", "errorMessage", });
...
///////////////////////    			
				...
				util_tLogRow_1.addRow(new String[] { "gender", "GenderWiseCount", });
...
///////////////////////    			
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.gender = aggregated_row_tAggregateRow_1.gender;
					row2.GenderWiseCount = (int) aggregated_row_tAggregateRow_1.count;
					row2.GenderWiseCount = (int) aggregated_row_tAggregateRow_1.GenderWiseCount_clmCount;
...
///////////////////////		
					...
					if (row2.gender != null) { //
						row_tLogRow_1[0] = String.valueOf(row2.gender);

					} //

					if (row2.GenderWiseCount != null) { //
						row_tLogRow_1[1] = String.valueOf(row2.GenderWiseCount);
...
///////////////////////    			
					...
					ope_tFilterRow_1.matches(
							(row3.GenderWiseCount == null ? false
									: row3.GenderWiseCount
											.compareTo(ParserUtils.parseTo_Integer(String.valueOf(3))) == 0),
							"GenderWiseCount.compareTo(3) == 0 failed");
					...
					if (ope_tFilterRow_1.getMatchFlag()) {
						...
						row4.GenderWiseCount = row3.GenderWiseCount;
						nb_line_ok_tFilterRow_1++;
					} else {
						if (row5 == null) {
							row5 = new row5Struct();
						}
						row5.gender = row3.gender;
						row5.GenderWiseCount = row3.GenderWiseCount;
...
///////////////////////		
						...
						if (row4.gender != null) { //
							row_tLogRow_2[0] = String.valueOf(row4.gender);

						} //

						if (row4.GenderWiseCount != null) { //
							row_tLogRow_2[1] = String.valueOf(row4.GenderWiseCount);
...
///////////////////////		
						...
						if (row5.gender != null) { //
							row_tLogRow_3[0] = String.valueOf(row5.gender);

						} //

						if (row5.GenderWiseCount != null) { //
							row_tLogRow_3[1] = String.valueOf(row5.GenderWiseCount);

						} //

						if (row5.errorMessage != null) { //
							row_tLogRow_3[2] = String.valueOf(row5.errorMessage);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final t_aggr t_aggrClass = new t_aggr();

		int exitCode = t_aggrClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = t_aggr.class.getClassLoader()
					.getResourceAsStream("local_project/t_aggr_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = t_aggr.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : t_aggr");
		}
...
/************************************************************************************************
 * 97128 characters generated by Talend Open Studio for Data Integration on the
 * June 6, 2021 at 5:59:36 PM IST
 ************************************************************************************************/